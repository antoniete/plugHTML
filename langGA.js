{
    "cookies": [
        ...
        "deu-lhe um biscoito que está perguntando: Quantos cm?",
        "deu-lhe um enorme biscoito. Quando o toca, mais biscoitos aparecem. Estranho.",
        "deu-lhe um biscoito , tem escrito: Cospe ou Engole?",
        "deu-lhe um biscoito que tá escrito: seis horas pra tocar uma música? isso não existe",
        "deu-lhe um biscoito da sorte, tem escrito: \"Arrisque-se!\"",
        "deu-lhe um biscoito da sorte, tem escrito: \"Segura essa marimba ai monamour.\"",
        ...
        "deu-lhe um biscoito da sorte, tem escrito: \"Seje menas, ok?\"",
    ...
    "balls": [
        ...
        "Quem sabe?",
        "Claro!",
        "Vai se foder arrombada, se situa!",
        "Est\u00e1 brincando?",
        "N\u00e3o aposte nisso.",
        "Esque\u00e7a isso."
    ],
    ...
    "bouncer": "O botzinho n\u00e3o pode mover pessoas na fila de espera quando usado por um bouncer :(",
    "online": "\/me %%BOTNAME%% phynissimo ativado! :heart: :sparkles:",
    "welcome": "Bem vindo(a) more, @%%NAME%% :heart: :sparkles:",
    "welcomeback": "Bem vindo(a) de volta more, @%%NAME%% :heart: :sparkles:",
    "songknown": "@%%NAME%%, essa m\u00fasica est\u00e1 no hist\u00f3rico, sua cega!",
    "notavailable": "\/me @%%NAME%%, a m\u00fasica que voc\u00ea tocou n\u00e3o est\u00e1 dispon\u00edvel, que peninha. ;(",
    "timelimit": "@%%NAME%%, sua m\u00fasica tem dura\u00e7\u00e3o maior que %%MAXLENGTH%% minutos. O máximo é 8min, tá bom more?",
    ...
    "isopen": "@djs A Russian Roulette foi iniciada! Digite !join para participar! (Jogo onde se voc\u00ea for O GRANDE ESCOLHIDO ganhará uma posição) Que a sorte esteja com você! :snake:",
    "winnerpicked": "\/me :tada: Um vencedor foi escolhido! @%%NAME%% PARABÉNS MOREEEE VC GANHOU A POSIÇÃO %%POSITION%%. :nail_care: :sparkles:",
    ...
    "notdisconnected": "\/me @%%NAME%% não se desconectou, greedy!",
    "noposition": "\/me \u00daltima posi\u00e7\u00e3o n\u00e3o reconhecida. A fila de espera precisa ser atualizada pelo menos uma vez para registrar posi\u00e7\u00f5es. Se fodeu otária! :gun:",
    "toolongago": "\/me @%%NAME%%'s desconectou-se a muito tempo atr\u00e1s: %%TIME%%, cry baby! ;(",
    ...
    "warning2": "@%%NAME%%, voc\u00ea ser\u00e1 removido em breve por inatividade se n\u00e3o responder! CORRE QUE D\u00e1 TEMPO!",
    ...
    "caps": "@%%NAME%%, deixe de fazer a  escandalosa e desligue seu capslock, ok more?",
    "askskip": "@%%NAME%%, não peça para pular sua mimada.",
    "spam": "\/me @%%NAME%%, n\u00e3o fa\u00e7a spam, t\u00e1 bom more?",
    "roomadvertising": "@%%NAME%%, n\u00e3o poste link de outras comunidades, por favor.",
    "adfly": "@%%NAME%%, por favor mude seu autowoot. N\u00f3s sugerimos o RCS: http:\/\/rcs.radiant.dj\/",
    ...
    "autowoot": "\/me N\u00f3s recomendamos RCS para autowoot (Dar legal automaticamente, e outras v\u00e1rias funções): https://rcs.radiant.dj/\/",
    ...
    "chatcleared": "\/me [@%%NAME%%] O chat foi limpo, boa noite.",
    "deletechat": "\/me [@%%NAME%%] O chat de %%USERNAME%% foi limpo, boa noite.",
    "commandslink": "\/me Comandos do %%BOTNAME%%: %%LINK%%",
    "eatcookie": "\/me Amo cookies.",
    "nousercookie": "\/em N\u00e3o vejo %%NAME%% na sala. Otario, peguei o cookie pra mim.",
    "selfcookie": "\/me @%%NAME%%, voc\u00ea \u00e9 uma baleia mesmo viu viado?, n\u00e9? Dando cookies para voce mesmo. Divide com as amigas!",
    ...
    "pong": "\/me Se tiver ping, mas n\u00e3o tiver pong, não vai ter jogo eu quero é ping pong!",
    "reload": "\/me Reiniciando... Voltei! :nail_care:",
    ...
    "thorcd": "\/me @%%NAME%% voc\u00ea s\u00f3 poder\u00e1 tentar levantar o martelo novamente em %%TIME%% mínutos.",
    "thorWorthy": "\/me @%%NAME%% voc\u00ea \u00e9 digno do martelo, meus parab\u00e1ins.",
    "thorNotWorthy": "\/me @%%NAME%% voc\u00ea n\u00e3o \u00e9 digno do martelo."
}
